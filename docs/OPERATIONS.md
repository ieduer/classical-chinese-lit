## 2026-09-26 detailed learning recorder accepted

Accepted runtime source `c2607698c4d4f2922584ecd0400c56304c49cd2d`, Pages `03db7a47-48ed-4b99-aea9-b1e16cbae769`, merged PR2 through the registered provider-pinned native publisher. All15 artifacts, source/tree/policy provenance, unchanged configuration and domains pass. HTML differences are only the exact previously accepted hidden link and reversible email protection; immutable deployment HTML is byte-exact.

Real authenticated production synthetic question/reply retain full original text, independent times, parent, canonical digest, original owner and one row each after reload. Local full UI/native IndexedDB additionally verifies request/failure recording, lost acknowledgement, original-owner recovery, no cross-account adoption or display, and390px layout. Beijing content hash,12 progress tests and7 capture tests pass on pinned Node24.18.0. External models0, grade writes0, notifications0; synthetic record_only/notStudentWork only.

Rollback is Pagesf54fe139-37b9-4c97-897f-98a46e4145bc / source1d22f9fc79bb335bdd1148f543211112de7304ca, preserving forward records. No natural learner coverage, unattended server delivery or historical backfill claim. Unknown model/version remains null. Single authority: `/Users/ylsuen/CF/reports/operations/learning-records-validity-20260925/MF_RELEASE.md`. This docs branch is separate from accepted runtime; canonical dirty work is untouched.
...
- Pages `mf`: verified production `f54fe139-37b9-4c97-897f-98a46e4145bc`, source `1d22f9fc79bb335bdd1148f543211112de7304ca`, 11 artifact entries; policy `.release/policies.json`. Automatic production remains enabled through the provider-pinned guard.
